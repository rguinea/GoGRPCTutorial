...
import (
	...
	rkt "github.com/rguinea/GoGRPCTutorial/protos/rocket/v1"
...
func (h Handler) GetRocket(ctx context.Context, req *rkt.GetRocketRequest) (*rkt.GetRocketResponse, error) {
	...
	foundRocket, err := h.RocketService.GetRocketByID(ctx, req.Id)
	log.Printf("----rocket----- %v", foundRocket)
	if err != nil {
